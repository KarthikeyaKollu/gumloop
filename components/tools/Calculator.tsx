...
const Calculator = () => {
  ...
  return (
    <div className={`relative flex w-full transition-all`}>
      {/* Main Container */}
      <div className="bg-white w-full rounded-2xl shadow-lg p-2 border-4 border-gray-200 flex flex-col">
        
        {/* Header */}
        <div className="bg-gray-100 p-4 rounded-xl">
          <div className="flex items-center gap-3 p-2 rounded-xl">
            <div className="bg-gray-400 p-4 rounded-lg text-white relative shadow-xl">
            ...
            <div className="flex flex-col flex-grow">
              <span className="text-sm text-black">Calculator</span>
              <h4 className="text-black">Get calculator Transcript</h4>
            </div>
            ...
            <div className="flex items-center">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-10 h-5 bg-gray-300 rounded-full peer peer-checked:bg-gray-500 relative">
